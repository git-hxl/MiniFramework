...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_UnknownFieldSet_Binding
    {
        ...
        static StackObject* WriteTo_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.UnknownFieldSet instance_of_this_method = (Google.Protobuf.UnknownFieldSet)typeof(Google.Protobuf.UnknownFieldSet).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* MergeFrom_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Google.Protobuf.UnknownFieldSet @other = (Google.Protobuf.UnknownFieldSet)typeof(Google.Protobuf.UnknownFieldSet).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Google.Protobuf.UnknownFieldSet @unknownFields = (Google.Protobuf.UnknownFieldSet)typeof(Google.Protobuf.UnknownFieldSet).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
