...
public class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBinding()
    {
        ...
        ILRuntime.Runtime.CLRBinding.BindingCodeGenerator.GenerateBindingCode(types, "Assets/MiniFramework/ILRuntime/Generated");
    ...
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        using (System.IO.FileStream fs = new System.IO.FileStream("Assets/StreamingAssets/HotFix.dll", System.IO.FileMode.Open, System.IO.FileAccess.Read))
        {
            ...
            ILRuntime.Runtime.CLRBinding.BindingCodeGenerator.GenerateBindingCode(domain, "Assets/MiniFramework/ILRuntime/Generated");
        }
        AssetDatabase.Refresh();
    }
    ...
    static void InitILRuntime(ILRuntime.Runtime.Enviorment.AppDomain domain)
    {
        ...
        domain.RegisterCrossBindingAdaptor(new IMessageAdaptor());
        ...
        //ILRuntime在分析时会执行pb中的静态构造函数,里面使用了跨域调用Func<T>
        domain.DelegateManager.RegisterFunctionDelegate<IMessageAdaptor.Adaptor>();
    }
}
#endif
