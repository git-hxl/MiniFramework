...
namespace MiniFramework
{
    public class DataPacker
    {
        ...
        public byte[] Packer(PackHead head, byte[] bodyData)
        {
            ...
            byte[] headData = SerializeHelper.SerializeByMarshal(head);
        ...
        public void UnPack(byte[] data)
        {
            ...
            int headLength = SerializeHelper.SerializeByMarshal(head).Length;
            ...
            head = SerializeHelper.DeserializeByMarshal<PackHead>(headData);
